    ...
    <section className="mx-auto max-w-6xl px-4 py-16">
      ...
      <div className="mt-10 grid gap-8 md:grid-cols-3">
        {[
          ...
          ['Training & handoff', 'Live walk-through and Q&A so you are confident on day one.']
        ].map(([title, body]) => (
      ...
      <div className="mt-12 rounded-2xl border border-neutral-200 p-6">
        ...
        <p className="mt-2 text-neutral-700">Tell us your current system and target timeline. We will reply within one business day.</p>

        <div className="mt-6">
          <LeadForm />
        </div>

        <p className="mt-3 text-xs text-neutral-500">We will never share your info. You will get a simple scope & next steps.</p>
      </div>
