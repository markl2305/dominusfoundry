...
export default function QBMigration() {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight tracking-tight text-gray-900">
              QuickBooks Desktop Is Going Away. <span className="text-blue-900">Your Financial History Doesn't Have To.</span>
            </h1>
        ...
        <div className="rounded-2xl border-2 border-orange-200 bg-orange-50 p-6 md:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <div className="flex gap-3">
              ...
              <div>
                <div className="font-semibold text-gray-900">New licenses stopped</div>
                <p className="mt-1 text-gray-700">Intuit stopped selling Desktop licenses September 2024. You can't buy it anymore.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 text-orange-600 text-2xl">✗</div>
              <div>
                <div className="font-semibold text-gray-900">Support ending on rolling schedule</div>
                <p className="mt-1 text-gray-700">Desktop 2022 ended May 2025. Desktop 2024 ends 2027. Your version's clock is ticking.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 text-orange-600 text-2xl">✗</div>
              <div>
                <div className="font-semibold text-gray-900">Critical features shut down</div>
                <p className="mt-1 text-gray-700">No more bank feeds, payroll processing, or payment integrations. Manual entry only.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 text-orange-600 text-2xl">✗</div>
              <div>
                <div className="font-semibold text-gray-900">Security vulnerabilities</div>
                <p className="mt-1 text-gray-700">No security patches after support ends. Your financial data becomes a target.</p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-900 text-white text-xl font-bold mb-4">
                1
              </div>
              <h3 className="text-xl font-bold text-gray-900">We Export Your Data</h3>
              <p className="mt-3 text-gray-700">
                Secure extraction of your complete financial history—transactions, customers, vendors, chart of accounts.
              </p>
              <p className="mt-2 text-sm font-semibold text-blue-900">Days 1-2</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              ...
              <h3 className="text-xl font-bold text-gray-900">We Reconcile & Test</h3>
              <p className="mt-3 text-gray-700">
                Map your chart of accounts, verify balances, run reconciliation reports. Everything must match perfectly.
              </p>
              <p className="mt-2 text-sm font-semibold text-blue-900">Days 3-5</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
              ...
              <h3 className="text-xl font-bold text-gray-900">You Approve & Go Live</h3>
              <p className="mt-3 text-gray-700">
                Review everything, ask questions, then flip the switch. We stay with you for 30 days of post-migration support.
              </p>
              <p className="mt-2 text-sm font-semibold text-blue-900">Days 6-7</p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Choose Your Migration Tier</h2>
          <p className="mt-4 text-lg text-gray-700">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl border-2 border-gray-200 bg-white p-6 md:p-8">
            <div className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Essential</div>
            <div className="mt-2 text-3xl font-bold text-gray-900">$500-750</div>
            <p className="mt-2 text-gray-600">For simple books and DIY owners</p>
            
            <ul className="mt-6 space-y-3">
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">Lists migration (customers, vendors, items)</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">Current year transactions only</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
              ...
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">Basic reconciliation report</span>
              </li>
            </ul>

            <a 
              href="#get-quote" 
              className="mt-8 block text-center rounded-xl border-2 border-gray-300 px-5 py-3 font-semibold text-gray-900 hover:bg-gray-50 transition-colors"
            >
              Get Quote
            </a>
          </div>
          ...
          <div className="rounded-2xl border-2 border-blue-900 bg-white p-6 md:p-8 relative shadow-lg">
            ...
            <div className="text-sm font-semibold text-blue-900 uppercase tracking-wide">Professional</div>
            <div className="mt-2 text-3xl font-bold text-gray-900">$1,200-1,800</div>
            <p className="mt-2 text-gray-600">For most businesses</p>
            ...
            <ul className="mt-6 space-y-3">
              ...
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700"><strong>3 years</strong> of historical data</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">Full reconciliation report</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
              ...
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">CPA handoff packet</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">30-day post-migration support</span>
              </li>
            </ul>

            <a 
              href="#get-quote" 
              className="mt-8 block text-center rounded-xl bg-blue-900 px-5 py-3 font-semibold text-white hover:bg-blue-800 transition-colors"
            >
              Get Quote
            </a>
          </div>
          ...
          {/* Enterprise */}
          <div className="rounded-2xl border-2 border-gray-200 bg-white p-6 md:p-8">
            <div className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Enterprise</div>
            <div className="mt-2 text-3xl font-bold text-gray-900">$2,500-4,000</div>
            <p className="mt-2 text-gray-600">For complex books</p>
            ...
            <ul className="mt-6 space-y-3">
              ...
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700"><strong>5+ years</strong> of historical data</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">Custom chart of accounts mapping</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">Direct CPA coordination call</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
                <span className="text-gray-700">2-hour training session</span>
              </li>
              <li className="flex gap-2">
                <span className="text-green-600 font-bold">✓</span>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-blue-100 text-sm">All transactions, lists, balances</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-2xl">✓</div>
              <div>
                ...
                <p className="mt-1 text-blue-100 text-sm">Logical structure preserved</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-2xl">✓</div>
              <div>
                ...
                <p className="mt-1 text-blue-100 text-sm">Every penny accounted for</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-2xl">✓</div>
              <div>
                ...
                <p className="mt-1 text-blue-100 text-sm">Proof everything matches</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-2xl">✓</div>
              <div>
                ...
                <p className="mt-1 text-blue-100 text-sm">30 days included</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="text-2xl">✓</div>
              <div>
                ...
                <p className="mt-1 text-blue-100 text-sm">Zero risk of data loss</p>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <div className="rounded-2xl border border-gray-200 bg-gray-50 p-8 md:p-10">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">Our Process Guarantees</h2>
          
          <div className="grid gap-6 md:grid-cols-2">
            <div className="flex gap-4">
              <div className="flex-shrink-0 text-3xl">🔒</div>
              <div>
                <div className="font-bold text-gray-900 text-lg">Zero Data Loss</div>
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 text-3xl">📊</div>
              <div>
                <div className="font-bold text-gray-900 text-lg">CPA-Ready Reports</div>
                <p className="mt-2 text-gray-700">
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 text-3xl">💰</div>
              <div>
                <div className="font-bold text-gray-900 text-lg">Fixed Price, No Surprises</div>
                <p className="mt-2 text-gray-700">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <div className="font-bold text-gray-900 text-lg">Clear Timeline</div>
                <p className="mt-2 text-gray-700">
      ...
      <section id="get-quote" className="mx-auto max-w-4xl px-4 py-12 md:py-16">
        <div className="rounded-2xl border-2 border-blue-900 bg-white p-6 md:p-10 shadow-xl">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Get Your Migration Quote</h2>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 md:py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">Common Questions</h2>
      ...
      <section className="bg-gradient-to-b from-white to-gray-50 py-12 md:py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Ready to Migrate With Confidence?</h2>
          <p className="mt-4 text-lg text-gray-700">
