...
export const metadata: Metadata = {
  ...
  description:
    'A reference, not an offer. A fully-loaded office coordinator runs about $5,500/mo. Forge is sold two ways. Iris is one tier — $2,000/mo for the ten founding operators, nine of which remain, and $3,500/mo standing once the charter closes — with Forge Core included and never a separate line. The tools are bought a la carte on Core at $599/mo flat with unlimited users — Hyperion $499, Ariadne $499, Sigil $49, Torch $35 per phone number. A $1,000 one-time setup fee applies to either. Forge is sold at buildwithforge.app.',
