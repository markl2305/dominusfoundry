...
export const metadata = {
  title: "Dominus OS | Human-Governed Operating System | Dominus Foundry",
  description:
    "Dominus OS is where everything connects. A complete operational intelligence layer that coordinates decisions, maintains authority, and ensures nothing drifts.",
};
...
const journeySteps = [
  ...
  {
    stage: "Unlock Dominus OS",
    description: "When your operation runs on multiple systems, Dominus OS becomes the intelligence layer that coordinates everything. The full experience.",
  },
];
...
export default function DominusOSPage() {
  return (
    <>
      ...
      <section className="bg-[var(--foundry-bg)]">
        <div className="mx-auto max-w-5xl px-4 py-16 md:py-24 space-y-12">
          <div className="max-w-3xl space-y-4">
            <h2 className="heading-forge-lg text-slate-900">What makes Dominus OS different</h2>
            ...
            <p className="body-foundry text-slate-700 md:text-lg">
              Dominus OS was designed to prevent that — not through features, but through architecture. Every capability exists because it serves human authority and operational clarity.
            </p>
          </div>
      ...
      <section className="bg-gradient-to-b from-forge-900 to-steel-800 text-white">
        <div className="mx-auto max-w-6xl px-4 py-16 md:py-24 space-y-12">
          <div className="max-w-3xl space-y-4">
            ...
            <h2 className="heading-forge-lg text-white">Systems powered by Dominus OS</h2>
            <p className="body-foundry text-white/80 md:text-lg">
      ...
      <section className="bg-[var(--foundry-bg-alt)]">
        <div className="mx-auto max-w-5xl px-4 py-16 md:py-24 space-y-12">
          <div className="text-center space-y-4">
            <h2 className="heading-forge-lg text-slate-900">How organizations arrive at Dominus OS</h2>
      ...
      {/* What Full Dominus OS Looks Like */}
      <section className="bg-tan-100">
        <div className="mx-auto max-w-4xl px-4 py-16 md:py-24 space-y-8">
          <div className="text-center space-y-4">
            <h2 className="heading-forge-lg text-slate-900">When everything runs on Dominus OS</h2>
          </div>
      ...
      <section className="bg-[var(--foundry-bg)]">
        <div className="mx-auto max-w-4xl px-4 py-16 md:py-24 space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="body-foundry text-slate-700 max-w-2xl mx-auto">
              Dominus OS as a complete deployment is for organizations that want unified operational intelligence from day one. It&apos;s founder-intensive, deeply customized, and built for operators who understand the value of systems that don&apos;t drift.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="card-forged rounded-2xl bg-white p-6 shadow-sm space-y-3">
              ...
              <p className="body-foundry text-slate-700">
                Most organizations begin here. Pick the system that solves your most urgent problem. Experience the quality. Add more when you&apos;re ready. Dominus OS emerges naturally as your systems grow.
              </p>
            ...
            <div className="card-forged-premium rounded-2xl bg-gradient-to-br from-forge-50 to-white p-6 shadow-lg space-y-3">
              <h3 className="heading-forge-md text-slate-900">Deploy Dominus OS directly</h3>
              <p className="body-foundry text-slate-700">
      ...
      <section className="bg-forge-900 text-white">
        <div className="mx-auto max-w-4xl px-4 py-14 md:py-18 text-center space-y-4">
          ...
          <p className="body-foundry text-forge-100/80">
            That&apos;s the Dominus OS experience.
          </p>
        </div>
      </section>
    </>
