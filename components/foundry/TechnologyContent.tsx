      ...
      <section className="pullband section" id="moat">
        <div className="wrap">
          ...
          <p className="sub reveal d1">
            Hyperion isn&apos;t a feature — it&apos;s an architecture: 19 provisional patent applications and a non-provisional filing, patent pending. Every capture runs on infrastructure we own at a flat rate, with no per-token vendor exposure — so the marginal cost of intelligence falls as volume grows, across every
